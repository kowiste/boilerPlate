...
type UserServiceClient interface {
	...
	// Get user by ID
	GetUserById(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetUserByIdResponse, error)
}
...
func (c *userServiceClient) GetUserById(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetUserByIdResponse, error) {
...
type UserServiceServer interface {
	...
	// Get user by ID
	GetUserById(context.Context, *GetByIdRequest) (*GetUserByIdResponse, error)
...
func (UnimplementedUserServiceServer) GetUserById(context.Context, *GetByIdRequest) (*GetUserByIdResponse, error) {
